...
const AdminServices = () => {
    ...
    useEffect(() => {
        ...
        const items = servicesList.slice(indexOfFirstItem, indexOfLastItem);
    ...
    }, [currentPage, itemsPerPage, servicesList]);
    ...
    return (
        <div className='services-component'>
            ...
            <div className="showListServices">
                ...
                <div className="show_grid_list_services">
                    {currentItems?.map((elem,i) => {
                        return (
                            <div className="items-new" key={i}>
                                ...
                                <h6>{elem.brand}</h6>
                                {editItemId == elem.id ? <>
                                    <button onClick={() => updatedServices(elem.id,servicename,price)}>
                                        Save Edit
                                    </button>
                                </> : <>
                                    <button onClick={() => handleChangeServices(elem)}>
                                        Edit
                                    </button>
                                </>}
                                <button onClick={() => deleteServices(elem)}>
                                    Delete
                                </button>
                            </div>
                        )
