...
import { authentication, facebook, google } from '../../lib/firebase'
...
const Login = () => {
    ...
    const handleInfo = (provider) => {
        if (state?.infostatus == 'info') {
            loginAccount(provider,'customer')
            return navigate('/info',{ state : state.item})
        } else {
            loginAccount(provider,'customer')
            return navigate('/')
        }
            ...
            <div className="login-subcomponent">
                <div className='signin-component'>
                    ...
                    <div className="link-in-accounts">
                        ...
                        onClick={() => handleInfo(google)}>
                            Login with Google
                        </button>
                        <button className='button-links' 
                        onClick={() => handleInfo(facebook)}>
                            Login with Facebook
                        </button>
                    </div>
                </div>
