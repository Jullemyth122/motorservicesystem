...
const Register = () => {
    ...
    const handleSubmit = e => {
        ...
        if (( username.length >= 5 && email == email.match(isValidEmail) && password.length >= 6 ) == false) {
        return setErrors({
            user_: username.length >= 5 ? '' : 'Full Name is not min 5 letters.',
        ...
        return setErrors({
            ...
            .then(res => {
                ...
                if (state?.infostatus) {
                    navigate('/info', {state: state.item })   
                } else {
                    setTimeout(() => {
                        navigate('/')
                    },500)
            ...
            .catch(err => {
                ...
                if (err.code == 'auth/email-already-in-use') {
                    ...
                    return setErrors({pass_:"Password is not at least 6 characters."})
                }
            })
        }
                        ...
                        <div className="input-form">
                            <div className="logo">
                                <svg width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.6667 32L20.3334 25.3334H33.6667V32H13.6667ZM3.66671 28.6667H6.00004L20.375 14.2917L18.0417 11.9584L3.66671 26.3334V28.6667ZM27.5 11.875L20.4167 4.87502L25.125 0.166687L32.1667 7.20835L27.5 11.875ZM0.333374 32V24.9167L18 7.25002L25.0834 14.3334L7.41671 32H0.333374ZM19.2084 13.125L18.0417 11.9584L20.375 14.2917L19.2084 13.125Z" fill="white"/>
                                </svg>
                            </div>
